...
class auto_word_wind_cft(models.Model):
    ...
    string_speed_words = fields.Char(string=u'测风塔选定风速结果', readonly=True, compute='_compute_cft')
    string_deg_words = fields.Char(string=u'测风塔选定风向结果', readonly=True, compute='_compute_cft')
